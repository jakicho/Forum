...
public class RowLayout extends ViewGroup {
    ...
    public RowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray styledAttributes = context.obtainStyledAttributes(attrs, co.forum.app.R.styleable.RowLayout);
        horizontalSpacing = styledAttributes.getDimensionPixelSize(co.forum.app.R.styleable.RowLayout_android_horizontalSpacing,
                DEFAULT_HORIZONTAL_SPACING);
        verticalSpacing = styledAttributes.getDimensionPixelSize(co.forum.app.R.styleable.RowLayout_android_verticalSpacing,
    ...
    private final class RowMeasurement {
        ...
        public boolean wouldExceedMax(int childWidth) {
            return widthMode == View.MeasureSpec.UNSPECIFIED ? false : getNewWidth(childWidth) > maxWidth;
        }
